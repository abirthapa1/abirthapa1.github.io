...
const Work = () => {
  return (
    <div id="work" className="w-full px-[12%] py-10 scroll-mt-20">
      ...
      <h2 className="text-center text-5xl font_Ovo">My Latest Work</h2>
      <p className="text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo">
        Welcome to my cloud engineering portfolio! Explore a collection of
        projects highlighting my skills in cloud infrastructure, DevOps, and
        automation.
      </p>
